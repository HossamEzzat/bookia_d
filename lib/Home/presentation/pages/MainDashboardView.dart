  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          'My Bookmarks',
          style: TextStyle(fontFamily: 'Georgia', fontWeight: FontWeight.bold, color: Color(0xFF1E232C)),
        ),
      ),
      body: BlocBuilder<HomeCubit, HomeStates>(
        builder: (context, state) {
            ...
            if (bookmarkedBooks.isEmpty) {
              return const Center(
                child: Column(
                  ...
                  children: [
                    Icon(Icons.bookmark_border, size: 80, color: Color(0xFF8391A1)),
                    SizedBox(height: 16),
                    Text(
                      'No Bookmarks Yet',
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text(
                      book.category,
                      style: const TextStyle(color: Color(0xFFC3A15C), fontWeight: FontWeight.w600, fontSize: 12),
                    ),
                    trailing: Row(
          ...
          return const Center(child: CircularProgressIndicator(color: Color(0xFFC3A15C)));
        },
      ),
    );
  }
            ...
            if (cartBooks.isEmpty) {
              return const Center(
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.shopping_bag_outlined, size: 80, color: Color(0xFF8391A1)),
                    SizedBox(height: 16),
                    Text(
                      'Your Cart is Empty',
                      style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1E232C)),
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          const Text(
                            'Total Price:',
                            style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Color(0xFF8391A1)),
                          ),
                          Text(
                            formattedTotal,
                            style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Color(0xFF1E232C)),
                          ),
                        ],
                      ),
